...
export function usePWAInstall() {
  ...
  useEffect(() => {
    ...
    const dismissedAt = localStorage.getItem('akira_pwa_install_dismissed_at');
    if (dismissedAt) {
    ...
    const handleAppInstalled = () => {
      ...
      localStorage.removeItem('akira_pwa_install_dismissed_at');
    };
  ...
  const dismissInstall = () => {
    setIsDismissed(true);
    localStorage.setItem('akira_pwa_install_dismissed_at', Date.now().toString());
  };
