...
const DEFAULT_EVENTS: CanonicalEvent[] = [
  ...
  {
    id: 'evt_world_un_ai_treaty_2026',
    title: 'United Nations General Assembly Adopts Historic Global AI Governance & Safety Treaty',
    summary: '193 member states establish binding international safety protocols, algorithmic transparency mandates, and sovereign AI development assistance funds.',
    regionId: 'world',
    categoryId: 'politics',
    urgencyLabel: 'BREAKING',
    importanceScore: 97,
    velocityScore: 94,
    finalRankScore: 98,
    whyItMatters: 'Establishes the first unified international legal framework for autonomous AI safety, preventing misuse and protecting democratic digital rights worldwide.',
    firstPublishedAt: new Date(Date.now() - 1 * 3600000).toISOString(),
    lastUpdatedAt: new Date(Date.now() - 15 * 60000).toISOString(),
    sourceCount: 3,
    lifecycleStatus: 'OFFICIAL_CONFIRMATION',
    ...
    sources: [
      {
        ...
        eventId: 'evt_world_un_ai_treaty_2026',
        sourceId: 'un-news',
        sourceName: 'UN News',
        title: 'UN General Assembly unanimously adopts landmark charter on frontier AI governance',
        url: 'https://news.un.org/en/story/2026/09/ai-treaty-global-safety',
        snippet: 'Resolution creates the International AI Safety Inspectorate to audit dual-use generative architectures.',
        publishedAt: new Date(Date.now() - 1 * 3600000).toISOString(),
        tier: 1,
        createdAt: new Date(Date.now() - 1 * 3600000).toISOString(),
      },
      {
        ...
        sourceId: 'bbc-world',
        sourceName: 'BBC News',
        title: 'Global powers sign landmark treaty to regulate artificial intelligence systems',
        url: 'https://www.bbc.com/news/world-global-ai-accord-2026',
        snippet: 'Agreement establishes global thresholds for frontier model audits, watermarking, and critical infrastructure guardrails.',
  ...
  {
    id: 'evt_world_wto_digital_trade_2026',
    title: 'World Trade Organization Ratifies Global E-Commerce & Cross-Border Digital Accord',
    summary: '90 nations approve zero-tariff protocols on digital transmissions and establish standard data interoperability rules.',
    regionId: 'world',
    categoryId: 'economy',
    urgencyLabel: 'BREAKING',
    importanceScore: 93,
    velocityScore: 89,
    finalRankScore: 94,
    whyItMatters: 'Lowers transaction costs for global digital enterprises and creates predictable cross-border commerce rules.',
    firstPublishedAt: new Date(Date.now() - 2 * 3600000).toISOString(),
    lastUpdatedAt: new Date(Date.now() - 35 * 60000).toISOString(),
    sourceCount: 2,
    lifecycleStatus: 'OFFICIAL_CONFIRMATION',
    metadata: { is_dev_sample: true },
    createdAt: new Date(Date.now() - 2 * 3600000).toISOString(),
    sources: [
      {
        ...
        eventId: 'evt_world_wto_digital_trade_2026',
        sourceId: 'bbc-business',
        sourceName: 'BBC News (Business)',
        title: 'WTO seals historic plurilateral agreement on digital trade regulations',
        url: 'https://www.bbc.com/news/business-wto-digital-pact-2026',
        snippet: 'Ministers confirm ban on customs duties for electronic transmissions and establish consumer protection baselines.',
        publishedAt: new Date(Date.now() - 2 * 3600000).toISOString(),
        tier: 1,
        createdAt: new Date(Date.now() - 2 * 3600000).toISOString(),
      },
  ...
  {
    id: 'evt_world_who_health_2026',
    title: 'World Health Organization Validates Next-Generation Universal mRNA Vaccine Platform',
    summary: 'Clinical trials demonstrate high neutralizing antibody persistence against evolving viral variants with room-temperature stability.',
    regionId: 'world',
    categoryId: 'health',
    urgencyLabel: 'BREAKING',
    importanceScore: 95,
    velocityScore: 91,
    finalRankScore: 96,
    whyItMatters: 'Eliminates complex ultra-cold chain logistics, dramatically improving life-saving therapeutics distribution across developing nations.',
    firstPublishedAt: new Date(Date.now() - 3 * 3600000).toISOString(),
    lastUpdatedAt: new Date(Date.now() - 50 * 60000).toISOString(),
    sourceCount: 2,
    lifecycleStatus: 'OFFICIAL_CONFIRMATION',
    metadata: { is_dev_sample: true },
    createdAt: new Date(Date.now() - 3 * 3600000).toISOString(),
    sources: [
      {
        ...
        eventId: 'evt_world_who_health_2026',
        sourceId: 'sciencedaily-health',
        sourceName: 'ScienceDaily (Health)',
        title: 'Universal mRNA platform demonstrates broad neutralizing coverage in phase-3 multi-center trial',
        url: 'https://www.sciencedaily.com/releases/2026/09/universal-mrna-platform',
        snippet: 'Novel lipid nanoparticle formulation preserves potency at ambient temperatures for up to six months.',
        publishedAt: new Date(Date.now() - 3 * 3600000).toISOString(),
        tier: 1,
        createdAt: new Date(Date.now() - 3 * 3600000).toISOString(),
      },
  ...
  {
    id: 'evt_world_jwst_astronomy_2026',
    title: 'James Webb Space Telescope Confirms Atmospheric Biosignatures on Habitable-Zone Exoplanet',
    summary: 'Spectroscopic data reveals dimethyl sulfide and atmospheric methane ratios consistent with biological processes 120 light-years away.',
    regionId: 'world',
    categoryId: 'science',
    urgencyLabel: 'TRENDING',
    importanceScore: 96,
    velocityScore: 93,
    finalRankScore: 97,
    whyItMatters: 'Marks the strongest candidate detection of prebiotic or extraterrestrial biological signatures in astronomical history.',
    firstPublishedAt: new Date(Date.now() - 4 * 3600000).toISOString(),
    lastUpdatedAt: new Date(Date.now() - 1 * 3600000).toISOString(),
    sourceCount: 2,
    lifecycleStatus: 'NEW_DEVELOPMENT',
    ...
    sources: [
      {
        ...
        eventId: 'evt_world_jwst_astronomy_2026',
        sourceId: 'nasa-news',
        sourceName: 'NASA Breaking News',
        title: 'Webb telescope deep transmission spectroscopy confirms chemical markers in exoplanet atmosphere',
        url: 'https://www.nasa.gov/missions/webb/exoplanet-atmosphere-detection-2026',
        snippet: 'Astronomers observe definitive molecular absorption bands in the habitable zone of star K2-18.',
        publishedAt: new Date(Date.now() - 4 * 3600000).toISOString(),
        tier: 1,
        createdAt: new Date(Date.now() - 4 * 3600000).toISOString(),
      },
  ...
  {
    id: 'evt_world_postquantum_security_2026',
    title: 'Global Internet Alliance Deploys Quantum-Resistant Encryption Across Core Telecommunications',
    summary: 'Tier-1 internet providers transition backbone fiber routing to lattice-based post-quantum cryptography standards.',
    regionId: 'world',
    categoryId: 'security',
    urgencyLabel: 'BREAKING',
    importanceScore: 92,
    velocityScore: 88,
    finalRankScore: 93,
    whyItMatters: 'Guarantees sovereign communication and encrypted banking protocols against future quantum decryption threats.',
    firstPublishedAt: new Date(Date.now() - 5 * 3600000).toISOString(),
    lastUpdatedAt: new Date(Date.now() - 2 * 3600000).toISOString(),
    sourceCount: 2,
    lifecycleStatus: 'OFFICIAL_CONFIRMATION',
    ...
    sources: [
      {
        ...
        eventId: 'evt_world_postquantum_security_2026',
        sourceId: 'bleepingcomputer',
        sourceName: 'BleepingComputer',
        title: 'Global transit operators implement post-quantum cryptographic key exchanges',
        url: 'https://www.bleepingcomputer.com/news/security/global-telco-quantum-crypto-rollout',
        snippet: 'New protocols mitigate "harvest now, decrypt later" adversary intelligence campaigns.',
        publishedAt: new Date(Date.now() - 5 * 3600000).toISOString(),
        tier: 1,
        createdAt: new Date(Date.now() - 5 * 3600000).toISOString(),
      },
  ...
  {
    id: 'evt_world_iter_fusion_2026',
    title: 'International Fusion Energy Consortium Achieves 1,000-Second High-Confinement Plasma Record',
    summary: 'Superconducting tokamak facility sustains steady-state fusion plasma with positive thermal power gain at 150 million degrees Celsius.',
    regionId: 'world',
    categoryId: 'energy',
    urgencyLabel: 'IMPORTANT',
    importanceScore: 94,
    velocityScore: 87,
    finalRankScore: 94,
    whyItMatters: 'Validates physics engineering models for commercial zero-carbon fusion baseload electricity generation.',
    ...
    sources: [
      {
        ...
        eventId: 'evt_world_iter_fusion_2026',
        sourceId: 'sciencedaily',
        sourceName: 'ScienceDaily',
        title: 'Tokamak achieves record steady-state burning plasma confinement milestone',
        url: 'https://www.sciencedaily.com/releases/2026/09/fusion-plasma-1000s-record',
        snippet: 'Advanced magnetic diverter architecture withstands extreme heat flux while sustaining core reaction efficiency.',
  ...
  {
    id: 'evt_world_unesco_open_science_2026',
    title: 'UNESCO Launches Global Open Science Repository Unlocking 100 Million Academic Papers',
    summary: 'International initiative mandates open-access public repositories for all publicly funded scientific research and datasets.',
    regionId: 'world',
    categoryId: 'education',
    urgencyLabel: 'IMPORTANT',
    importanceScore: 90,
    velocityScore: 81,
    finalRankScore: 91,
    whyItMatters: 'Democratizes scientific knowledge globally, accelerating research in medicine, climate mitigation, and computational science.',
    ...
    sources: [
      {
        ...
        eventId: 'evt_world_unesco_open_science_2026',
        sourceId: 'dw-world',
        sourceName: 'Deutsche Welle (World)',
        title: 'UNESCO open science portal grants global researchers free access to peer-reviewed breakthroughs',
        url: 'https://www.dw.com/en/unesco-open-science-repository-launch-2026',
        snippet: 'Agreement unites 120 national research councils in universal open-access preprint indexation.',
  ...
  {
    id: 'evt_world_battery_solidstate_2026',
    title: 'Global Automotive & Energy Consortium Begins Commercial Production of 1,000 km Solid-State Batteries',
    summary: 'Next-generation solid ceramic electrolyte batteries achieve 12-minute 80% ultra-fast charging without thermal degradation.',
    regionId: 'world',
    categoryId: 'technology',
    urgencyLabel: 'TRENDING',
    importanceScore: 91,
    velocityScore: 85,
    finalRankScore: 92,
    whyItMatters: 'Revolutionizes electric transit range, accelerates commercial aviation decarbonization, and enhances grid energy storage safety.',
    firstPublishedAt: new Date(Date.now() - 9 * 3600000).toISOString(),
    lastUpdatedAt: new Date(Date.now() - 4 * 3600000).toISOString(),
    sourceCount: 2,
    lifecycleStatus: 'NEW_DEVELOPMENT',
    metadata: { is_dev_sample: true },
    ...
    sources: [
      {
        ...
        eventId: 'evt_world_battery_solidstate_2026',
        sourceId: 'techcrunch',
        sourceName: 'TechCrunch',
        title: 'Solid-state battery lines enter mass-scale commercial production',
        url: 'https://techcrunch.com/2026/09/solid-state-battery-commercial-deployment',
        snippet: 'Automakers prepare 2027 fleet deployments featuring ceramic solid electrolyte pouch cells.',
